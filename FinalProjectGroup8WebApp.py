...
if menu == "Home":
    ...
    st.markdown(
        ...
        <div class="Home">
            ...
            <img src="https://raw.githubusercontent.com/ahmadfaqihy/WebAppGroup8/master/logo_pu.png" alt="Logo" style="width: 200px; display: block; margin-left: auto; margin-right: auto;">
